...
#define SYSAHBCLKCTRL_Val        0x0001405F
...
ZERO_INIT uint32_t SystemFrequency; /*!< System Clock Frequency (Core Clock)  */

#define SIMPLE_CLOCK_INIT
